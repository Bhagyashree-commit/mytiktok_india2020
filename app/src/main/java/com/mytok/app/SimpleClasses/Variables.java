...
public class Variables {
    ...
    public static final String app_folder=root+"/MYTok/";
    ...
    public static String tag="Mytok_";
    ...
    public static String gif_api_key1="b0FzJcLRPcLR3IsDlG7BldNsKwhQuPcC";

    public static final String privacy_policy="https://mytok.flycricket.io/privacy.html";


   
    public static final  String main_domain="http://hellotokindia.com/";
